...
class Account extends React.Component {
  ...
  handleUserLogin() {
    this.props.login(
      this.state.login.usernameOrEmail,
  ...
  render() {
    ...
    const notLoggedIn = (
      ...
      >
        ...
        <Segment padded style={{ width: "300px" }}>
          <Button primary={true} fluid={true} onClick={this.handleUserLogin}>
            Login
          </Button>
          ...
          <Modal
            ...
            onClose={this.handleSignupModalOnClose}
            closeIcon
          >
    ...
    return (
      <div>{this.props.auth.isAuthenticated ? isLoggedIn : notLoggedIn}</div>
    );
  }
}
